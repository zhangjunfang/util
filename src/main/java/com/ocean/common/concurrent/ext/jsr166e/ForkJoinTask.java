...
/**
 * http://gee.cs.oswego.edu/cgi-bin/viewcvs.cgi/jsr166/src/jsr166e/ForkJoinTask.java
 * 1.19
 * 
 ...
 *
 * <p>
 * It is possible to define and use ForkJoinTasks that may block, but doing so
 ...
 * the use of {@link java.util.concurrent.Phaser Phaser}, {@link #helpQuiesce},
 * and {@link #complete}) that may be of use in constructing custom subclasses
 * for problems that are not statically structured as DAGs. To support such
 * usages, a ForkJoinTask may be atomically <em>tagged</em> with a {@code short}
 * value using {@link #setForkJoinTaskTag} or
 * {@link #compareAndSetForkJoinTaskTag} and checked using
 * {@link #getForkJoinTaskTag}. The ForkJoinTask implementation does not use
 * these {@code protected} methods or tags for any purpose, but they may be of
 * use in the construction of specialized subclasses. For example, parallel
 * graph traversals can use the supplied methods to avoid revisiting nodes/tasks
 * that have already been processed. (Method names for tagging are bulky in part
 * to encourage definition of methods that reflect their usage patterns.)
 *
 * <p>
...
public abstract class ForkJoinTask<V> implements Future<V>, Serializable {
	...
	public boolean tryUnfork() {
		...
		return (((t = Thread.currentThread()) instanceof ForkJoinWorkerThread)
				? ((ForkJoinWorkerThread) t).workQueue.tryUnpush(this) : ForkJoinPool.common.tryExternalUnpush(this));
	}
	 ...
	 * @param tag
	 *            the new tag value
	 * @return {@code true} if successful; i.e., the current value was equal to
	 *         e and is now tag.
	 * @since 1.8
	 */
	...
	/**
	 * Adapter for Runnables. This implements RunnableFuture to be compliant
