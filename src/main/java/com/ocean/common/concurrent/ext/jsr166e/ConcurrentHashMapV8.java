...
/**
 * http://gee.cs.oswego.edu/cgi-bin/viewcvs.cgi/jsr166/src/jsr166e/RecursiveTask.java
 * 1.126
 * 
 ...
 * any hash table. To ameliorate impact, when keys are {@link Comparable}, this
 ...
 *
 * <p>
 * ConcurrentHashMapV8s support a set of sequential and parallel bulk operations
 * that are designed to be safely, and often sensibly, applied even with maps
 * that are being concurrently updated by other threads; for example, when
 * computing a snapshot summary of the values in a shared registry. There are
 * three kinds of operation, each with four forms, accepting functions with
 * Keys, Values, Entries, and (Key, Value) arguments and/or return values.
 * Because the elements of a ConcurrentHashMapV8 are not ordered in any
 * particular way, and may be processed in different orders in different
 * parallel executions, the correctness of supplied functions should not depend
 * on any ordering, or on any other objects or values that may transiently
 * change while computation is in progress; and except for forEach actions,
 * should ideally be side-effect-free. Bulk operations on
 * {@link java.util.Map.Entry} objects do not support method {@code setValue}.
 *
 * <ul>
...
public class ConcurrentHashMapV8<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
	...
	/**
	 * An object for traversing and partitioning elements of a source. This
	 * interface provides a subset of the functionality of JDK8
	 * java.util.Spliterator.
	 */
	public static interface ConcurrentHashMapSpliterator<T> {
		/**
		 * If possible, returns a new spliterator covering approximately one
		 * half of the elements, which will not be covered by this spliterator.
		 * Returns null if cannot be split.
		 */
		ConcurrentHashMapSpliterator<T> trySplit();

		/**
		 * Returns an estimate of the number of elements covered by this
		 * Spliterator.
		 */
		long estimateSize();
	 ...
	 * unused constructor arguments referring to concurrencyLevel. We accept a
	 ...
	 * @since 1.8
	 */
	public <U> void forEach(long parallelismThreshold, BiFun<? super K, ? super V, ? extends U> transformer,
	 ...
	 * @since 1.8
	 */
	public <U> U reduce(long parallelismThreshold, BiFun<? super K, ? super V, ? extends U> transformer,
	 ...
	 * @since 1.8
	 */
	public double reduceToDouble(long parallelismThreshold, ObjectByObjectToDouble<? super K, ? super V> transformer,
	 ...
	 * @since 1.8
	 */
	public long reduceToLong(long parallelismThreshold, ObjectByObjectToLong<? super K, ? super V> transformer,
	 ...
	 * @since 1.8
	 */
	public int reduceToInt(long parallelismThreshold, ObjectByObjectToInt<? super K, ? super V> transformer, int basis,
	 ...
	 * @since 1.8
	 */
	public <U> void forEachKey(long parallelismThreshold, Fun<? super K, ? extends U> transformer,
			Action<? super U> action) {
		if (transformer == null || action == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public <U> U reduceKeys(long parallelismThreshold, Fun<? super K, ? extends U> transformer,
			BiFun<? super U, ? super U, ? extends U> reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public double reduceKeysToDouble(long parallelismThreshold, ObjectToDouble<? super K> transformer, double basis,
	 ...
	 * @since 1.8
	 */
	public long reduceKeysToLong(long parallelismThreshold, ObjectToLong<? super K> transformer, long basis,
	 ...
	 * @since 1.8
	 */
	public int reduceKeysToInt(long parallelismThreshold, ObjectToInt<? super K> transformer, int basis,
			IntByIntToInt reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public <U> void forEachValue(long parallelismThreshold, Fun<? super V, ? extends U> transformer,
			Action<? super U> action) {
		if (transformer == null || action == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public <U> U reduceValues(long parallelismThreshold, Fun<? super V, ? extends U> transformer,
			BiFun<? super U, ? super U, ? extends U> reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public double reduceValuesToDouble(long parallelismThreshold, ObjectToDouble<? super V> transformer, double basis,
			DoubleByDoubleToDouble reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public long reduceValuesToLong(long parallelismThreshold, ObjectToLong<? super V> transformer, long basis,
			LongByLongToLong reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public int reduceValuesToInt(long parallelismThreshold, ObjectToInt<? super V> transformer, int basis,
			IntByIntToInt reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public <U> void forEachEntry(long parallelismThreshold, Fun<Map.Entry<K, V>, ? extends U> transformer,
			Action<? super U> action) {
		if (transformer == null || action == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public <U> U reduceEntries(long parallelismThreshold, Fun<Map.Entry<K, V>, ? extends U> transformer,
			BiFun<? super U, ? super U, ? extends U> reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public double reduceEntriesToDouble(long parallelismThreshold, ObjectToDouble<Map.Entry<K, V>> transformer,
			double basis, DoubleByDoubleToDouble reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public long reduceEntriesToLong(long parallelismThreshold, ObjectToLong<Map.Entry<K, V>> transformer, long basis,
			LongByLongToLong reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	 ...
	 * @since 1.8
	 */
	public int reduceEntriesToInt(long parallelismThreshold, ObjectToInt<Map.Entry<K, V>> transformer, int basis,
			IntByIntToInt reducer) {
		if (transformer == null || reducer == null)
			throw new NullPointerException();
	...
	static final class ForEachEntryTask<K, V> extends BulkTask<K, V, Void> {
		...
		ForEachEntryTask(BulkTask<K, V, ?> p, int b, int i, int f, Node<K, V>[] t, Action<? super Entry<K, V>> action) {
			super(p, b, i, f, t);
			this.action = action;
		}
	...
	static final class ForEachTransformedMappingTask<K, V, U> extends BulkTask<K, V, Void> {
		...
		ForEachTransformedMappingTask(BulkTask<K, V, ?> p, int b, int i, int f, Node<K, V>[] t,
				BiFun<? super K, ? super V, ? extends U> transformer, Action<? super U> action) {
			super(p, b, i, f, t);
			this.transformer = transformer;
			this.action = action;
		}
