 ...
 * <ul>
 * <li>has public
 * {@link org.springframework.util.ResizableByteArrayOutputStream#grow(int)} and
 * {@link org.springframework.util.ResizableByteArrayOutputStream#resize(int)}
 * methods to get more control over the size of the internal buffer</li>
 * <li>has a higher initial capacity (256) by default</li>
 * </ul>
 *
 * <p>
 * As of 4.2, this class has been superseded by
 * {@link FastByteArrayOutputStream} for Spring's internal use where no
 * assignability to {@link ByteArrayOutputStream} is needed (since
 * {@link FastByteArrayOutputStream} is more efficient with buffer resize
 * management but doesn't extend the standard {@link ByteArrayOutputStream}).
 *
 * @author Brian Clozel
...
public class ResizableByteArrayOutputStream extends ByteArrayOutputStream {
	...
	/**
	 * Create a new <code>ResizableByteArrayOutputStream</code> with the default
	...
	/**
	 * Create a new <code>ResizableByteArrayOutputStream</code> with the
	 ...
	 *             if the given capacity is smaller than the actual size of the
