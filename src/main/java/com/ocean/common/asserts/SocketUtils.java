...
public class SocketUtils {
	 ...
	 * the fully qualified class name to SpEL's {@code T()} function for each
	 * usage. Thus, the fact that this constructor is {@code public} allows you
	 * to reduce boilerplate configuration with SpEL as can be seen in the
	 * following example.
	 * 
	 * <pre>
