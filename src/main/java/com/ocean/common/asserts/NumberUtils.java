 ...
 * for a more comprehensive suite of number utilities.
 *
...
public abstract class NumberUtils {
	...
	/**
	 * Standard number types (all immutable): Byte, Short, Integer, Long,
	...
	/**
	 * Raise an <em>overflow</em> exception for the given number and target
	 * class.
	 * 
	 * @param number
	...
	/**
	 * Parse the given {@code text} into a {@link Number} instance of the given
	 * target class, using the supplied {@link NumberFormat}.
	 * <p>
	 * Trims the input {@code String} before attempting to parse the number.
	 * 
	 * @param text
	 ...
	 *            the target class to parse into
	 * @param numberFormat
	 *            the {@code NumberFormat} to use for parsing (if {@code null},
