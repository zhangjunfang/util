 ...
 * block size of 4096 bytes, and close all affected streams when done. A
 * variation of the copy methods from this class that leave streams open can be
 * found in {@link StreamUtils}.
 *
 * <p>
