...
package com.ocean.common.uid;

import static com.ocean.common.asserts.Assertions.isTrueArgument;
import static com.ocean.common.asserts.Assertions.notNull;
...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
	 ...
	 * used to create all ObjectIds this way, but it does not match the
	 * <a href="http://docs.mongodb.org/manual/reference/object-id/">ObjectId
	 ...
	 *            the ByteBuffer
	 * @throws IllegalArgumentException
	 *             if the buffer is null or does not have at least 12 bytes
	 *             remaining
	 * @since 3.4
	 */
	public ObjectId(final ByteBuffer buffer) {
		...
		// Note: Cannot use ByteBuffer.getInt because it depends on tbe buffer's
		// byte order
	...
	/**
	 * Convert to bytes and put those bytes to the provided ByteBuffer. Note
	 * that the numbers are stored in big-endian order.
	 *
	 * @param buffer
	 *            the ByteBuffer
	 * @throws IllegalArgumentException
